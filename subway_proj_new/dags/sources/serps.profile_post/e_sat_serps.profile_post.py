...
# Заполнение Satellite с помощью dbt
  ...
  # Client
    ...
    e_satelite_dbt_client = PythonOperator(
        ...
        op_kwargs={"models": ["ins_to_e_sat_client_profile_card_post_pg.sql"]},
        dag = dag,
    )
   ...
   # Card
    ...
    e_satelite_dbt_card = PythonOperator(
        ...
        python_callable = run_dbt_commands,
        op_kwargs={"models": ["ins_to_e_sat_card_profile_card_post_pg.sql"]},
        dag = dag,
    )
    ...
    e_satelite_ins_client = PostgresOperator(
        ...
        sql = 'Insert into dbt_schema."GPR_RV_E_CLIENT" select * from ins_to_e_sat_client_profile_card_post_pg',
        dag = dag, 
    )
    ...
    e_satelite_ins_card = PostgresOperator(
        ...
        postgres_conn_id = 'dbt_postgres',
        sql = 'Insert into dbt_schema."GPR_RV_E_CARD" select * from ins_to_e_sat_card_profile_card_post_pg',
        dag = dag, 
    )
