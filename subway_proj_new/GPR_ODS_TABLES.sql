...
select * from dbt_schema.ods_cut_client_profile_card_post_pg;

select * from dbt_schema.ods_receipt_post;
select * from dbt_schema.ods_cut_receipt_profile_card_post_pg;

select * from dbt_schema.ods_client_csv;
select * from dbt_schema.ods_cut_client_from_star_orcl;
...
delete from dbt_schema.ods_cut_client_profile_card_post_pg;

delete from dbt_schema.ods_receipt_post;
delete from dbt_schema.ods_cut_receipt_profile_card_post_pg;

delete from dbt_schema.ods_client_csv;
delete from dbt_schema.ods_cut_client_from_star_orcl;
