...
CREATE TABLE dbt_schema."GPR_RV_M_CLIENT_PHONES" (
	dataflow_id text,
	dataflow_dttm text,
	source_system_dk oid,
	client_rk text,
	...
	actual_flg integer,
	delete_flg integer,
	phone_number_desc varchar,
	question1_cnt integer,
	question2_cnt integer,
	question3_cnt integer
);

CREATE TABLE dbt_schema."GPR_RV_S_CLIENT_CLIENT_FIREBIRD" (
	dataflow_id text,
	dataflow_dttm timestamp,
	source_system_dk oid,
	client_rk text,
...
CREATE TABLE dbt_schema."GPR_BV_P_CLIENT" (
	...
	client_phones_vf_dttm timestamp
);
...
drop table dbt_schema."GPR_RV_M_CLIENT_PHONES";
drop table dbt_schema."GPR_RV_S_CLIENT_CLIENT_FIREBIRD";
...
select * from dbt_schema."GPR_RV_M_CLIENT_PHONES";
select * from dbt_schema."GPR_RV_S_CLIENT_CLIENT_FIREBIRD";
...
delete from dbt_schema."GPR_RV_M_CLIENT_PHONES";
delete from dbt_schema."GPR_RV_S_CLIENT_CLIENT_FIREBIRD";
