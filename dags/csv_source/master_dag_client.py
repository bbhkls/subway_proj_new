...
with DAG(
    ...
    trigger_ora_post = TriggerDagRunOperator(
        task_id='ora_post',
        trigger_dag_id='L_from_ora_to_postgres_client',
    ...
    trigger_cut_ods = TriggerDagRunOperator(
        task_id='cut_ods',
        trigger_dag_id='L_cut_ods_table_client',
        execution_date='{{ execution_date }}',
        reset_dag_run=True,
    ...
    trigger_hub_mod = TriggerDagRunOperator(
        task_id='hub_mod',
        trigger_dag_id='L_source_csv_hub_client',
        execution_date='{{ execution_date }}',
    ...
    trigger_sat_mod = TriggerDagRunOperator(
        task_id='sat_mod',
        trigger_dag_id='L_source_csv_sat_client',
        execution_date='{{ execution_date }}',
        trigger_run_id='{{ run_id }}',
        reset_dag_run=True,
        wait_for_completion = True,
    ...
    trigger_e_sat_mod = TriggerDagRunOperator(
        task_id='e_sat_mod',
        trigger_dag_id='L_source_csv_e_sat_client',
        execution_date='{{ execution_date }}',
        trigger_run_id='{{ run_id }}',
        reset_dag_run=True,
        wait_for_completion = True,
    ...
    trigger_meta_mod = TriggerDagRunOperator(
        task_id='meta_mod',
        trigger_dag_id='L_source_csv_meta_client',
        execution_date='{{ execution_date }}',
        trigger_run_id='{{ run_id }}',
        reset_dag_run=True,
        wait_for_completion = True,
